<?php include("header.php");
   if(isset($_GET['id']) && !empty($_GET['id'])){
        $id = $_GET['id'];
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT t1.*,t2.class_name FROM `cca` as t1 join class_schedules as t2 on t1.schedule=t2.class_schedules_id WHERE t1.cca_id = '$id'"));
    }
 ?>
<section id="middle">
    ...
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['cca_id'])?'Edit CCA (Sporting) ':'Add CCA (Sporting)';?></h2>
            </div>
            <div class="panel-body">
                <form action="" id = "formaddcca" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">

                            <div class="row">
                                <div class="col-md-6 col-sm-6 ">
                                    <label>CCA (Sporting) Name *</label>
                                    <input type="text"  placeholder = "CCA (Sporting) Name" class = "form-control" name = "cca_name" id = "cca_name" title = "First Name Required"  value="<?php echo isset($data['cca_name'])?$data['cca_name']:''?>"required>
                                </div>
                                <div class="col-md-6 col-sm-6 ">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" data-lang="en" placeholder = "CCA Group Number" class = "form-control" name = "cca_group" id = "cca_group" title = "Finish Date Required"  value="<?php echo isset($data['cca_group'])?$data['cca_group']:''?>"required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 text-center">
                                       <input type ="hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddCCA">
                                        <input type="submit"  id="formvalidate" data-form="formaddcca"  class="btn btn-info btn-md btn-submit" value="<?php echo isset($id)?'Edit CCA (Sporting)':'Add CCA (Sporting)'?>">
                                    </div>
                                </div>
                            </div>
