<?php include("header.php");
   if(isset($_GET['id']) && !empty($_GET['id'])){
        ...
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT a.*,p.* FROM school_application a LEFT JOIN student_profile p ON a.student_app_id=p.student_app_id  WHERE p.student_app_id = '$student_app_id'"));
                        ...
                        <div class="form-group">
                            ...
                            <div id="fragment-1" class="tab-pane active">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <input type="text"  placeholder = "Student Id" class = "form-control" name = "student_id_number" id = "student_id_number" title = "Student ID "  value="<?php echo isset($data['student_id_number'])?$data['student_id_number']:''?>" disabled > 
                                </div>                                  
                                </div>	
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Student Name" class = "form-control" name = "student_name" id = "student_name" title = "Student Name Required"  value="<?php echo isset($data['student_name'])?$data['student_name']:''?>" disabled>
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <label class="radio-inline">
                                          <input type="radio" name="gender" id="gender" value="Male" <?php if((isset($data['gender'])) && ($data['gender']=='Male')){ echo "checked"; } ?> disabled>Male
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="gender" id="gender" value="Female" <?php if((isset($data['gender'])) && ($data['gender']=='Female')){ echo "checked"; } ?> disabled>Female
                                        </label>
                                    </div>  
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" class="form-control datepicker" data-format="dd/mm/yyyy" data-lang="en" data-RTL="false"  placeholder = "Date of Birth" class = "form-control" name = "dob" id = "dob" title = "Date of Birth Required"  value="<?php echo isset($data['dob'])?$data['dob']:''?>" disabled>
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Age </label><br>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text"  placeholder = "Year" class = "form-control" name = "age_year" id = "age_year"  value="<?php echo isset($data['age_year'])?$data['age_year']:''?>" disabled>
                                        </div>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text"  placeholder = "Month" class = "form-control" name = "age_month" id = "age_month" value="<?php echo isset($data['age_month'])?$data['age_month']:''?>" disabled>
                                        </div>
                                    </div>  
                                </div> 
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Nationality" class = "form-control" name = "nationality" id = "nationality" title = "Nationality Required"  value="<?php echo isset($data['nationality'])?$data['nationality']:''?>" disabled>
                                    </div>
                                    
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Grade *</label>
                                        <input type="text"  placeholder = " grade" class = "form-control" name = "grade" id = "current_grade" title = "Current Grade Required"  value="<?php echo isset($data['grade'])?$data['grade']:''?>"  disabled>
                                    </div> 
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Camp Enrolled" class = "form-control" name = "camp_enrolled" id = "camp_enrolled" title = "Camp Enrolled Required"  value="<?php echo isset($data['camp_enrolled'])?$data['camp_enrolled']:''?>" disabled>

                                    </div> 
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Student Type (Boarding/Day Student) *</label>
                                        
                                        <select class="form-control" name = "student_type" id = "student_type" disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" class="form-control"   placeholder = "Academic Class (Assigned)" class = "form-control" name = "academic_class" id = "academic_class" title = "Academic Class (Assigned) Required"  value="<?php echo isset($data['academic_class'])?$data['academic_class']:''?>" disabled>
                                        
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Boarding Allocation </label>
                                        <div class="fancy-form fancy-form-select">
                                        <select class="form-control select2"  id="boarding_room_id" name="boarding_room_id" disabled>
                                                <option value="">--Select--</option>
                                            <?php
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" class="form-control"   placeholder = "Transport Routes" class = "form-control" name = "transport_routes" id = "transport_routes" title = "Transport Routes Required"  value="<?php echo isset($data['transport_routes'])?$data['transport_routes']:''?>" disabled>
                                        
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label>English Name *</label>
                                        <input type="text"  placeholder = "English Name" class = "form-control" name = "english_name" id = "english_name" title = "English Name Required"  value="<?php echo isset($data['english_name'])?$data['english_name']:''?>"  disabled>
                                    </div>
                            ...
                            <div id="fragment-2" class="tab-pane">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does the applicant have siblings / family members attending camp RAS? &nbsp;
                                            <input type="checkbox" class="not_extra" name="siblings" id="siblings" value="1" <?php if((isset($data['siblings'])) && ($data['siblings']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                ...
                                <div class="row campers_valid">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "campers name" class = "form-control" name = "campers_name" id = "campers_name" title = "campers name Required"  value="<?php echo isset($data['campers_name'])?$data['campers_name']:''?>" disabled>
                                    </div> 
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <textarea class="form-control" rows="5" name="address" id="address" disabled><?php echo isset($data['address'])?$data['address']:''?> </textarea>
                                    </div>
                                </div> 
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Mother Name" class = "form-control" name = "mother_name" id = "mother_name" title = "Mother Name Required"  value="<?php echo isset($data['mother_name'])?$data['mother_name']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Email(Mother) *</label>
                                        <input type="text"  placeholder = "Email Mother" class = "form-control" name = "mother_email" id = "mother_email" title = "Email Mother Required"  value="<?php echo isset($data['mother_email'])?$data['mother_email']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Mother Mobile" class = "form-control" name = "mother_mobile" id = "mother_mobile" title = "Mother Mobile Required"  value="<?php echo isset($data['mother_mobile'])?$data['mother_mobile']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Home Phone Number: </label>
                                        <input type="text"  placeholder = "Home Phone Number" class = "form-control" name = "home_phone" id = "home_phone" title = "Home Phone Number Required"  value="<?php echo isset($data['home_phone'])?$data['home_phone']:''?>" disabled>
                                    </div>
                                </div>  
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Father Name" class = "form-control" name = "father_name" id = "father_name" title = "Father Name Required"  value="<?php echo isset($data['father_name'])?$data['father_name']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Email(Father) *</label>
                                        <input type="text"  placeholder = "Email Father" class = "form-control" name = "father_email" id = "father_email" title = "Email Father Required"  value="<?php echo isset($data['father_email'])?$data['father_email']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Father Mobile" class = "form-control" name = "father_mobile" id = "father_mobile" title = "Father Mobile Required"  value="<?php echo isset($data['father_mobile'])?$data['father_mobile']:''?>" disabled>
                                    </div>
                                </div> 
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "WeChat" class = "form-control" name = "wechat" id = "wechat" title = "WeChat Required"  value="<?php echo isset($data['wechat'])?$data['wechat']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Kakao Talk ID </label>
                                        <input type="text"  placeholder = "Kakao Talk" class = "form-control" name = "kakao_talk" id = "kakao_talk" title = "Kakao Talk Required"  value="<?php echo isset($data['kakao_talk'])?$data['kakao_talk']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Line ID</label>
                                        <input type="text"  placeholder = "Line ID" class = "form-control" name = "line_id" id = "line_id" title = "Line ID Required"  value="<?php echo isset($data['line_id'])?$data['line_id']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Whatsapp</label>
                                        <input type="text"  placeholder = "Whatsapp" class = "form-control" name = "whatsapp" id = "whatsapp" title = "Whatsapp Required"  value="<?php echo isset($data['whatsapp'])?$data['whatsapp']:''?>" disabled>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Name</label>
                                        <input type="text"  placeholder = "Relative Name" class = "form-control" name = "relative_name" id = "relative_name" title = "Relative Name Required"  value="<?php echo isset($data['relative_name'])?$data['relative_name']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Relation to Student</label>
                                        <input type="text"  placeholder = "Relation to Student" class = "form-control" name = "relation_student" id = "relation_student" title = "Relation to Student Required"  value="<?php echo isset($data['relation_student'])?$data['relation_student']:''?>" disabled>
                                    </div>
                                </div> 
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Email</label>
                                        <input type="email"  placeholder = "Relative Email" class = "form-control" name = "relative_email" id = "relative_email" title = "Relative Name Required"  value="<?php echo isset($data['relative_email'])?$data['relative_email']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Phone Number</label>
                                        <input type="text"  placeholder = "Relative Phone Number" class = "form-control" name = "relative_phone" id = "relative_phone" title = "Relative Phone Number Required"  value="<?php echo isset($data['relative_phone'])?$data['relative_phone']:''?>" disabled>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        <label class="switch switch switch-round">Boarding Allocation Requested? &nbsp;
                                            <input type="checkbox" class="not_extra" name="boarding_allocation_req" value="1" <?php if((isset($data['boarding_allocation_req'])) && ($data['boarding_allocation_req']=='1')){ echo "checked"; } ?> disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div> 
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Student Name" class = "form-control" name = "boarding_student_name" id = "boarding_student_name" title = "Boarding Student Required" value="<?php echo isset($data['boarding_student_name'])?$data['boarding_student_name']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                         <label>Gender *</label><br>
                                        <label class="radio-inline">
                                          <input type="radio" name="boarding_gender" value="male" <?php if((isset($data['boarding_gender'])) && ($data['boarding_gender']=='male')){ echo "checked"; } ?> disabled>Male
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="boarding_gender" value="female" <?php if((isset($data['boarding_gender'])) && ($data['boarding_gender']=='female')){ echo "checked"; } ?> disabled>Female
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Age</label>
                                        <input type="text"  placeholder = "Age" class = "form-control" name = "boarding_student_age" id = "boarding_student_age" title = "Boarding Age Required" value="<?php echo isset($data['boarding_student_age'])?$data['boarding_student_age']:''?>" disabled>
                                    </div>
                                </div>
                            ...
                            <div id="fragment-4" class="tab-pane">
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Applicant’s most proficient language" class = "form-control" name = "proficient_language" id = "proficient_language" title = "Applicant’s most proficient language Required"  value="<?php echo isset($data['proficient_language'])?$data['proficient_language']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Primary language at home:</label>
                                        <input type="text"  placeholder = "Primary language at home" class = "form-control" name = "primary_language_at_home" id = "primary_language_at_home" title = "Primary language at home Required"  value="<?php echo isset($data['primary_language_at_home'])?$data['primary_language_at_home']:''?>" disabled>
                                    </div>
                                </div> 
                                <div class="clearfix"></div>
                            <!-- </div> --> 
                            ...
                            <!-- <div class="collapse" id="parent_assessment"> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="reading_value" value="Sufficient" <?php if((isset($data['reading_value'])) && ($data['reading_value']=='Sufficient')){ echo "checked"; } ?> disabled >&nbsp;Sufficient
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="reading_value" value="Intermediate" <?php if((isset($data['reading_value'])) && ($data['reading_value']=='Intermediate')){ echo "checked"; } ?> disabled >&nbsp;Intermediate
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="reading_value" value="Beginner" <?php if((isset($data['reading_value'])) && ($data['reading_value']=='Beginner')){ echo "checked"; } ?> disabled >&nbsp;Beginner
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="reading_value" value="None" <?php if((isset($data['reading_value'])) && ($data['reading_value']=='None')){ echo "checked"; } ?> disabled >&nbsp;None
                                        </label>
                                    </div>   
                                </div> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="writing_value" value="Sufficient" <?php if((isset($data['writing_value'])) && ($data['writing_value']=='Sufficient')){ echo "checked"; } ?> disabled >&nbsp;Sufficient
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="writing_value" value="Intermediate" <?php if((isset($data['writing_value'])) && ($data['writing_value']=='Intermediate')){ echo "checked"; } ?> disabled >&nbsp;Intermediate
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="writing_value" value="Beginner" <?php if((isset($data['writing_value'])) && ($data['writing_value']=='Beginner')){ echo "checked"; } ?> disabled >&nbsp;Beginner
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="writing_value" value="None" <?php if((isset($data['writing_value'])) && ($data['writing_value']=='None')){ echo "checked"; } ?> disabled >&nbsp;None
                                        </label>
                                    </div>   
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="speaking_value" value="Sufficient" <?php if((isset($data['speaking_value'])) && ($data['speaking_value']=='Sufficient')){ echo "checked"; } ?>  disabled >&nbsp;Sufficient
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="speaking_value" value="Intermediate" <?php if((isset($data['speaking_value'])) && ($data['speaking_value']=='Intermediate')){ echo "checked"; } ?> disabled >&nbsp;Intermediate
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="speaking_value" value="Beginner" <?php if((isset($data['speaking_value'])) && ($data['speaking_value']=='Beginner')){ echo "checked"; } ?> disabled >&nbsp;Beginner
                                        </label>
                                    </div>
                                    <div class="col-md-2 col-sm-2 ">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="speaking_value" value="None" <?php if((isset($data['speaking_value'])) && ($data['speaking_value']=='None')){ echo "checked"; } ?> disabled >&nbsp;None
                                        </label>
                                    </div>   
                                </div>  
                                <div class="clearfix"></div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <textarea rows="5" placeholder = "Learning Notes" class = "form-control" name = "learning_notes" id = "learning_notes" title = "Applicant’s most proficient language Required"  value="" disabled><?php echo isset($data['learning_notes'])?$data['learning_notes']:''?></textarea>
                                    </div>
                                    <!-- <div class="col-md-6 col-sm-6 ">
                                        <label>Primary language at home:</label>
                            ...
                            <!-- <div class="collapse" id="support_services"> -->
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <label class="switch switch switch-round">Are there any behavioral or learning support needs that we should be aware of? &nbsp;
                                            <input type="checkbox" class="support" id="support" name="support" value="1" <?php if((isset($data['support'])) && ($data['support']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                ...
                                <div class="row support_needed">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <textarea class="form-control" rows="5" name="support_address" id="support_address" disabled><?php echo isset($data['support_address'])?$data['support_address']:''?></textarea>
                                    </div>
                                </div>
                            ...
                            <!-- <div class="collapse" id="trasportation_plan"> -->
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="transportation" value="Senai"  <?php if((isset($data['transportation'])) && ($data['transportation']=='Senai')){ echo "checked"; } ?> disabled>Senai
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="transportation" value="Changi"  <?php if((isset($data['transportation'])) && ($data['transportation']=='Changi')){ echo "checked"; } ?> disabled>Changi
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="transportation" value="No transport needed"  <?php if((isset($data['transportation'])) && ($data['transportation']=='No transport needed')){ echo "checked"; } ?> disabled>No transport needed
                                        </label>
                                    </div>
                                </div> 
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Flight Numbers (Arrive @ Start of Camp)" class = "form-control" name = "flight_numbers_arrive_start" id = "flight_numbers_arrive_start" title = "Flight Numbers (Arrive @ Start of Camp) Required"  value="<?php echo isset($data['flight_numbers_arrive_start'])?$data['flight_numbers_arrive_start']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Flight Arrive (Date) </label>
                                        <input type="text" class="form-control datepicker" data-format="dd/mm/yyyy" data-lang="en" data-RTL="false"  placeholder = "Flight Arrive (Date)" class = "form-control" name = "flight_arrive_date" id = "flight_arrive_date" title = "Flight Arrive (Date) Required"  value="<?php echo isset($data['flight_arrive_date'])?$data['flight_arrive_date']:''?>" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Flight Arrive (Time)  </label>
                                        <input type="text"  placeholder = "Flight Arrive (Time) " class = "form-control timepicker" name = "flight_arrive_time" id = "flight_arrive_time" title = "Flight Arrive (Time) Required"  value="<?php echo isset($data['flight_arrive_time'])?$data['flight_arrive_time']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Flight Numbers (Depart @ End of Camp)</label>
                                        <input type="text"  placeholder = "Flight Numbers (Depart @ End of Camp)" class = "form-control" name = "flight_numbers_depart_end" id = "flight_numbers_depart_end" title = "Flight Numbers (Depart @ End of Camp) Required"  value="<?php echo isset($data['flight_numbers_depart_end'])?$data['flight_numbers_depart_end']:''?>" disabled>
                                    </div>
                                    <!-- <div class="col-md-6 col-sm-6 ">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <input type="checkbox" class="not_extra" name="transport_student" value="1" <?php if((isset($data['transport_student'])) && ($data['transport_student']=='1')){ echo "checked"; } ?> disabled>
                                        <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <div class="col-md-3 col-sm-3 ">
                                            <label class="checkbox-inline">
                                                <input type="radio" name="student_pickup" value="1" <?php if((isset($data['student_pickup'])) && ($data['student_pickup']=='1')){ echo "checked"; } ?> disabled>Danga Bay (Starbucks)
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3 ">
                                            <label class="checkbox-inline">
                                                <input type="radio" name="student_pickup" value="2" <?php if((isset($data['student_pickup'])) && ($data['student_pickup']=='2')){ echo "checked"; } ?> disabled>Teega A (lobby)
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3 ">
                                            <label class="checkbox-inline">
                                                <input type="radio" name="student_pickup" value="3" <?php if((isset($data['student_pickup'])) && ($data['student_pickup']=='3')){ echo "checked"; } ?> disabled>Teega B (lobby)
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3 ">
                                            <label class="checkbox-inline">
                                                <input type="radio" name="student_pickup" value="4" <?php if((isset($data['student_pickup'])) && ($data['student_pickup']=='4')){ echo "checked"; } ?> disabled>Teega Suites (lobby)
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3 ">
                                            <label class="checkbox-inline">
                                                <input type="radio" name="student_pickup" value="5" <?php if((isset($data['student_pickup'])) && ($data['student_pickup']=='5')){ echo "checked"; } ?> disabled>Mall of medini(lobby) 
                                            </label>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" class="form-control datepicker" data-format="dd/mm/yyyy" data-lang="en" data-RTL="false"  placeholder = "Arrival Date" class = "form-control" name = "arrival_date" id = "arrival_date" title = "Arrival Date Required"  value="<?php echo isset($data['arrival_date'])?$data['arrival_date']:''?>" disabled>
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Arrival Time  </label>        
                                        <input type="text"  placeholder = "Arrival Time " class = "form-control timepicker " name = "arrival_time" id = "arrival_time"  value="<?php echo isset($data['arrival_time'])?$data['arrival_time']:''?>" disabled>
                                    </div>  
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Airport </label>
                                        <input type="text"  placeholder = "Airport " class = "form-control" name = "arrival_airport" id = "arrival_airport" title = "Airport Required"  value="<?php echo isset($data['arrival_airport'])?$data['arrival_airport']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Flight Number </label>
                                        <input type="text"  placeholder = "Flight Number " class = "form-control" name = "arrival_flight" id = "arrival_flight" title = "Flight Number Required"  value="<?php echo isset($data['arrival_flight'])?$data['arrival_flight']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" placeholder = "Drop Off Address " class = "form-control" name = "drop_off_address" id = "drop_off_address" title = "Drop Off Address Required"  value="<?php echo isset($data['drop_off_address'])?$data['drop_off_address']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Total PAX </label>
                                        <input type="number"  placeholder = "Total PAX" class = "form-control" name = "arrival_total_pax" id = "arrival_total_pax" title = "Total PAX Required"  value="<?php echo isset($data['arrival_total_pax'])?$data['arrival_total_pax']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Luggage </label>
                                        <input type="text" placeholder = "Luggage" class = "form-control" name = "arrival_luggage" id = "arrival_luggage" title = "Luggage Required"  value="<?php echo isset($data['arrival_luggage'])?$data['arrival_luggage']:''?>" disabled>
                            ...
                            <label><h1 class="panel-title">AIRPORT DEPARTURES  – TRANSPORTATION </h1></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" class="form-control datepicker" data-format="dd/mm/yyyy" data-lang="en" data-RTL="false"  placeholder = "Departure Date" class = "form-control" name = "departure_date" id = "departure_date" title = "Date of Birth Required"  value="<?php echo isset($data['departure_date'])?$data['departure_date']:''?>" disabled>
                                    </div>

                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Departure Time </label>        
                                        <input type="text" placeholder = "Departure Time" class = "form-control timepicker " name = "departure_time" id = "departure_time"  value="<?php echo isset($data['departure_time'])?$data['departure_time']:''?>" disabled  >
                                    </div>  
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        <label>Airport </label>
                                        <input type="text"  placeholder = "Airport " class = "form-control" name = "departure_airport" id = "departure_airport" title = "Airport Required"  value="<?php echo isset($data['departure_airport'])?$data['departure_airport']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Flight Number </label>
                                        <input type="text"  placeholder = "Flight Number " class = "form-control" name = "departure_flight" id = "departure_flight" title = "Relation to Student Required"  value="<?php echo isset($data['departure_flight'])?$data['departure_flight']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text" placeholder = "Pick up Address" class = "form-control" name = "pick_up_address" id = "pick_up_address" title = "Pick up Address Required"  value="<?php echo isset($data['pick_up_address'])?$data['pick_up_address']:''?>" disabled></textarea>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Total PAX  </label>
                                        <input type="number"  placeholder = "Total PAX" class = "form-control" name = "departure_total_pax" id = "departure_total_pax" title = "Total PAX Required"  value="<?php echo isset($data['departure_total_pax'])?$data['departure_total_pax']:''?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Luggage </label>
                                        <input type="text" placeholder = "Luggage" class = "form-control" name = "departure_luggage" id = "departure_luggage" title = "Luggage Required"  value="<?php echo isset($data['departure_luggage'])?$data['departure_luggage']:''?>" disabled>
                            ...
                            <!-- <div class="collapse" id="student_health_record"> -->
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does your child have any present illnesses? &nbsp;
                                            <input type="checkbox" class="not_extra" name="illnesses" id="illnesses" value="1" <?php if((isset($data['illnesses'])) && ($data['illnesses']=='1')){ echo "checked"; } ?> disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row illnesses_details">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <textarea class="form-control" rows="5" name="illnesses_details" id="illnesses_details"  disabled><?php echo isset($data['illnesses_details'])?$data['illnesses_details']:''?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does your child suffer from any allergies? &nbsp;
                                            <input type="checkbox" class="not_extra" id="allergies" name="allergies" value="1" <?php if((isset($data['allergies_details'])) && ($data['allergies']=='1')){ echo "checked"; } ?>   disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row allergies_details">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <textarea class="form-control" rows="5" name="allergies_details" id="allergies_details"  disabled><?php echo isset($data['allergies_details'])?$data['allergies_details']:''?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does your child experience any learning difficulties or mental impairments that we need to be aware of in order to cater for the needs of your child?&nbsp;
                                            <input type="checkbox" class="not_extra" name="mental_impairments" id="mental_impairments" value="1" <?php if((isset($data['mental_impairments'])) && ($data['mental_impairments']=='1')){ echo "checked"; } ?> disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row mental_impairments_details">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <textarea class="form-control" rows="5" name="mental_impairments_details" id="mental_impairments_details" disabled ><?php echo isset($data['mental_impairments_details'])?$data['mental_impairments_details']:''?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Has your child slept away from home for more than a week before?&nbsp;
                                            <input type="checkbox" class="not_extra" name="slept_away" value="1" <?php if((isset($data['slept_away'])) && ($data['slept_away']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does your child have a history of asthma?&nbsp;
                                            <input type="checkbox" class="not_extra" name="asthma" value="1" <?php if((isset($data['asthma'])) && ($data['asthma']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does he / she carry an asthma inhaler?&nbsp;
                                            <input type="checkbox" class="not_extra" name="inhaler" value="1" <?php if((isset($data['inhaler'])) && ($data['inhaler']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does your child wear glasses or contact lenses?&nbsp;
                                            <input type="checkbox" class="not_extra" name="lenses" value="1" <?php if((isset($data['lenses'])) && ($data['lenses']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Does your child have trouble hearing or use a hearing aid?&nbsp;
                                            <input type="checkbox" class="not_extra" name="hearing" value="1" <?php if((isset($data['hearing'])) && ($data['hearing']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Is your child on daily medication?&nbsp;
                                            <input type="checkbox" class="not_extra" name="daily_medication" value="1" <?php if((isset($data['daily_medication'])) && ($data['daily_medication']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4" style="margin-left: -163px;margin-top: -10px;">
                                        <input type="text"  placeholder = "Medication list" class = "form-control" name = "medication_list" id = "medication_list" title = "Mother Name Required"  value="<?php echo isset($data['medication_list'])?$data['medication_list']:''?>"  disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        ...
                                        <textarea class="form-control" rows="5" name="health_condition_details" id="health_condition_details"  disabled></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <label class="switch switch switch-round">Can your child swim?&nbsp;
                                            <input type="checkbox" class="not_extra" name="child_swim" value="1" <?php if((isset($data['child_swim'])) && ($data['child_swim']=='1')){ echo "checked"; } ?>  disabled>
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <input type="checkbox" name="attest_info" value="1" <?php if((isset($data['attest_info'])) && ($data['attest_info']=='1')){ echo "checked"; } ?>  disabled>&nbsp;I attest that all the above information is accurate.
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <input type="checkbox" name="give_permission" value="1" <?php if((isset($data['give_permission'])) && ($data['give_permission']=='1')){ echo "checked"; } ?>  disabled>&nbsp;I hereby give permission to the school to administer the following medications to my child if deemed necessary by the school nurse:<br>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <input type="checkbox" name="give_permission_emergency" value="1" <?php if((isset($data['give_permission_emergency'])) && ($data['give_permission_emergency']=='1')){ echo "checked"; } ?>  disabled>&nbsp;I hereby give permission for emergency measures to be initiated in case of accident or sudden illness with the understanding that I will be notified.
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-12 col-sm-12 ">
                                        <input type="checkbox" name="permission_medical_staff" value="1" <?php if((isset($data['permission_medical_staff'])) && ($data['permission_medical_staff']=='1')){ echo "checked"; } ?>  disabled>&nbsp;I hereby give permission to the RAS Medical staff to administer medication that is prescribed to my child.
                                    </div>
                                </div>
                             ...
                             <div id="fragment-6" class="tab-pane">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Deposit of MYR" class = "form-control" name = "deposite" id = "deposite" title = "Student Name Required"  value="<?php echo isset($data['deposite'])?$data['deposite']:''?>" disabled>
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Receipt No." class = "form-control" name = "receipt" id = "receipt" title = "Student Name Required"  value="<?php echo isset($data['receipt'])?$data['receipt']:''?>" disabled>
                                    </div>  
                                </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = " Total Received" class = "form-control" name = "total_received" id = "total_received" title = "Student Name Required"  value="<?php echo isset($data['total_received'])?$data['total_received']:''?>" disabled>
                                    </div>  
                                    <div class="col-md-6 col-sm-6 ">
                                        <label> Total Camp Fee*</label>
                                        <input type="text"  placeholder = " Total Camp Fee" class = "form-control" name = "camp_fee" id = "camp_fee" title = "Student Name Required"  value="<?php echo isset($data['camp_fee'])?$data['camp_fee']:''?>" disabled>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Balance due  " class = "form-control" name = "bal_bue" id = "bal_bue" title = "Student Name Required"  value="<?php echo isset($data['bal_bue'])?$data['bal_bue']:''?>" disabled>
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Early Bird Discount*</label>
                                        <input type="text"  placeholder = "Early Bird Discount" class = "form-control" name = "early_bird_dis" id = "early_bird_dis" title = "Student Name Required"  value="<?php echo isset($data['early_bird_dis'])?$data['early_bird_dis']:''?>" disabled>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = " Discount 5%" class = "form-control" name = "discount" id = "discount" title = "Student Name Required"  value="<?php echo isset($data['discount'])?$data['discount']:''?>" disabled>
                                    </div> 
                                    <div class="col-md-6 col-sm-6 ">

                                        <label> Payment Type</label>
                                        <input type="text"  placeholder = " Payment Type" class = "form-control" name = "payment_type" id = "payment_type" title = "Student Name Required"  value="<?php echo isset($data['payment_type'])?$data['payment_type']:''?>" disabled>
                            ...
                            $i++;      
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <?php } ?>&nbsp;&nbsp;
                                        <?php if($r1['passport_copy'] != ''){ ?>
                                        <td><a href="../upload/<?php echo $r1['passport_copy'];?>"  download ><i class="fa fa-download"> Download</i> </a></td>
                                        <?php } ?>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">                                      
                                        <label>Final Application File</label><br>
                                         <?php if($r1['student_photo'] != ''){ ?>
                                        <td><a href="../upload/<?php echo $r1['final_application_form'];?>" ><i class="fa fa-eye"> View</i> </a></td>
                                        <?php } ?>&nbsp;&nbsp;
                                        <?php if($r1['student_photo'] != ''){ ?>
                                        <td><a href="../upload/<?php echo $r1['final_application_form'];?>" download ><i class="fa fa-download"> Download</i> </a></td>
                                        <?php } ?>
                                    </div>  
                                </div> 
                                 <?php }?>  
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12 text-center">
                               <!-- <input type ="hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>"> -->
                                ...
                                <input type="submit"  id="formvalidate" data-form="formaddproject"  class="btn btn-info btn-md btn-submit"  value="Add Student Profile">
                            </div>
                        </div>
                    </div>
                </form>
