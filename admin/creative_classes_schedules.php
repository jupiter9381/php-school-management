...
<section id="middle">
    ...
    <header id="page-header">
        <h1>Creative Classes Schedules</h1>
    </header>
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['camp_teacher_id'])?'Edit CreativeClasses':'Creative Classes Schedules';?></h2>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">                                
                                <div class="col-md-6 col-sm-6 ">
                                    <label>Creative Classes Schedules *</label>
                                ...
                                <div class="col-md-6 col-sm-6" style=" top: 25px";>
                                    ...
                                    <input type = "hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="Addclassattendance">
                                        <input type="submit"  id="formvalidate" data-form="formaddcreativeclasses"  class="btn btn-info btn-md btn-submit"  value="Search Creative Classes">
                                </div> 
                            </div>
                        ...
                        <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                            <thead>
                                <tr>
                                    ...
                                    <th>Creative Classes Schedules</th>
                                    <th>Action</th>  
                                </tr>
                            </thead>
                            <!-- <tbody>
