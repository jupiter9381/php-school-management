    ...
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['camp_teacher_id'])?'Edit ClassAssignments':'Class Assignments';?></h2>
            </div>
                            ...
                            <div class="row">                                
                                ...
                                <div class="col-md-6 col-sm-6" style=" top: 25px";>
                                    ...
                                    <input type = "hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddClassAssignments">
                                        <input type="submit"  id="formvalidate" data-form="formaddclassassignments"  class="btn btn-info btn-md btn-submit"  value="Search Class Assignments">
                                </div> 
                            </div>
