<?php include("header.php");
   if(isset($_GET['id']) && !empty($_GET['id'])){
        $id = $_GET['id'];
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM `boarding_staff` WHERE `boarding_staff_id` = '$id'"));
...
<section id="middle">
    ...
    <header id="page-header">
        <h1>Add Boarding Staff</h1>
    </header>
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['boarding_staff_id'])?'Edit Boarding Staff':'Update Boarding Staff';?></h2>
            </div>
            <div class="panel-body">
                <form action="" id = "formaddboardingstaff" method="post" enctype="multipart/form-data">
                    <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 text-center">
                                       <input type ="hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddBoardingStaff">
                                        <input type="submit" id="formvalidate" data-form="formaddboardingstaff"  class="btn btn-info btn-md btn-submit"  value="Add Boarding Staff">
                                    </div>
                                </div>
                            </div>
