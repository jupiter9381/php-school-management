...
if(isset($_GET['id']) && !empty($_GET['id'])){
        $id = $_GET['id'];
        //echo "SELECT s.*,c.camp_management_id,c.camp_name,c.start_date,c.finish_date FROM school_application s LEFT JOIN camp_management c ON s.camp_management_id=c.camp_management_id WHERE `student_app_id` = '$id'";
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT s.*,c.camp_management_id,c.camp_name,c.start_date,c.finish_date FROM school_application s LEFT JOIN camp_management c ON s.camp_management_id=c.camp_management_id WHERE `student_app_id` = '$id'"));
    }
  ?>
<html lang="en-US">
<head>
          ...
          <section>
          		<div class="cotainer">
                      ...
                      <p text-align="justify" style="font-size: 11px" ; ><i>*Please fill out the form below and Print it out and sign it, Please upload you completed and signed application form into the RAS Camp System or email it to <b>camp@rafflesamericanschool.org</b>, Hand written applications will not be accepted.</i>
          						...
          						<p> 
          							Name(first/middle/last):&nbsp;<u><?php echo $data['student_name'];?></u>&nbsp;&nbsp;&nbsp;Gender:&nbsp;<u><?php echo $data['gender'];?></u>
                        <!-- ____________Male______________Female -->
          						...
          						<p>
          							Date of Birth (DD/MM/YYYY):&nbsp;&nbsp;<u><?php echo date('d-m-Y',strtotime($data['dob']));?></u>&nbsp;&nbsp;Age:&nbsp;<u><?php echo $data['age_year'];?></u>&nbsp;&nbsp;Yrs. <u><?php echo $data['age_month'];?></u>&nbsp;&nbsp;Months &nbsp;Current grade:&nbsp;&nbsp;<u><?php echo $data['grade'];?></u>&nbsp;&nbsp;
          						</p>	
                        ...
                        Passport No.:&nbsp;&nbsp;<u><?php echo $data['passport_no'];?></u>&nbsp;&nbsp;Nationality: &nbsp;&nbsp;<u><?php echo $data['nationality'];?></u>&nbsp;&nbsp;Country Issuing Passport:&nbsp;&nbsp;<u><?php echo $data['issue_date_passport'];?></u>&nbsp;&nbsp;
          						...
          						<p>	
          			       Camp Selection:&nbsp;&nbsp;<u><?php echo $data['camp_name'];?> - <?php echo date('d-m-Y',strtotime($data['start_date']));?> - <?php echo date('d-m-Y',strtotime($data['finish_date']));?></u>&nbsp;&nbsp;
                       Boarding Requested?&nbsp;&nbsp; Yes &nbsp;&nbsp; <input type="text" class="border" name="boarding" readonly><?php if((isset($data['boarding_req'])) && ($data['boarding_req'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px'  style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;&nbsp;&nbsp; No &nbsp;&nbsp;  <input type="text" class="border" name="boarding" readonly><?php if((isset($data['boarding_req'])) && ($data['boarding_req'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>  
          						</p>
          						<p>
          						...
          						<p>
          							Does the applicant have siblings / family members attending camp RAS?&nbsp;&nbsp; Yes &nbsp;&nbsp; <input type="text" class="border" name="boarding" readonly> <?php if((isset($data['siblings'])) && ($data['siblings'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -19px;'>"; }?>&nbsp;&nbsp;&nbsp;&nbsp; No &nbsp;&nbsp;<input type="text" class="border" name="boarding" readonly><?php if((isset($data['siblings'])) && ($data['siblings'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						<p>	
          						...
          						<p>
          							Parent 1: &nbsp;&nbsp;<u><?php echo $data['mother_name'];?></u>&nbsp;&nbsp;

          						</p>
          						
          						<p>
          							Email (Parent 1): &nbsp;&nbsp;<u><?php echo $data['mother_email'];?></u>&nbsp;&nbsp; Mobile (Parent 1): &nbsp;&nbsp;<u><?php echo $data['mother_mobile'];?></u>&nbsp;&nbsp; Home Phone Number: &nbsp;&nbsp;<u><?php echo $data['home_phone'];?></u>&nbsp;&nbsp;
          						</p>          				
          						<p>
          							Parent 2:&nbsp;&nbsp;<u><?php echo $data['father_name'];?></u>&nbsp;&nbsp;
          						<p>
          							Email (Parent 2): &nbsp;&nbsp;<u><?php echo $data['father_email'];?></u>&nbsp;&nbsp;Mobile (Parent 2): &nbsp;&nbsp;<u><?php echo $data['father_mobile'];?></u>&nbsp;&nbsp;Home Phone Number: &nbsp;&nbsp;<u><?php echo $data['home_phone'];?></u>&nbsp;&nbsp;
          						</p>
          						<p>
                      ...
                      <p>
                       ...
                       Boarding Allocation Requested?&nbsp;&nbsp; Yes &nbsp;&nbsp; <input type="text" class="border" name="boarding" readonly><?php if((isset($data['boarding_allocation_req'])) && ($data['boarding_allocation_req'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px'  style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;&nbsp;&nbsp; No &nbsp;&nbsp;  <input type="text" class="border" name="boarding" readonly><?php if((isset($data['boarding_allocation_req'])) && ($data['boarding_allocation_req'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>  
                      </p>
          						<p>
          						...
          						<p>
          							<!--<input type="text" class="border" name="boarding" readonly><?php if((isset($data['is_reading'])) && ($data['is_reading'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>-->&nbsp;&nbsp;
                        <b>Reading :</b>
                        <font style=" margin-left: 20px;">
                        &nbsp;&nbsp;Sufficient
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['reading_value'])) && ($data['reading_value'] == 'Sufficient')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;</font> 
                        <font style=" margin-left: 19px;">
                        &nbsp;&nbsp;Intermediate
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['reading_value'])) && ($data['reading_value'] == 'Intermediate')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                      </font>  
                        <font style=" margin-left: 20px;">
                        &nbsp;&nbsp;Beginner 
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['reading_value'])) && ($data['reading_value'] == 'Beginner')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                      </font>
                        <font style=" margin-left: 21px;">
                          None
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['reading_value'])) && ($data['reading_value'] == 'None')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                      </font>
          						</p>
          						<p>
          						   <!--<input type="text" class="border" name="boarding" readonly><?php if((isset($data['is_speaking'])) && ($data['is_speaking'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>-->&nbsp;&nbsp;
                          <b>Speaking :</b>
                         <font style=" margin-left: 21px;">
                          Sufficient
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['speaking_value'])) && ($data['speaking_value'] == 'Sufficient')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                        </font>

                          <font style=" margin-left: 18px;">
                            &nbsp;&nbsp;Intermediate
                            <input type="text" class="border" name="boarding" readonly><?php if((isset($data['speaking_value'])) && ($data['speaking_value'] == 'Intermediate')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;</font> 
                          <font style=" margin-left: 20px;">
                            &nbsp;&nbsp;Beginner
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['speaking_value'])) && ($data['speaking_value'] == 'Beginner')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        </font>
                         <font style=" margin-left: 18px;">
                          &nbsp;&nbsp; None
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['speaking_value'])) && ($data['speaking_value'] == 'None')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        </font>
          						</p>
          						<p>
          						   <!--<input type="text" class="border" name="boarding" readonly><?php if((isset($data['is_writing'])) && ($data['is_writing'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>-->&nbsp;&nbsp;
                          <b>Writing :</b>
                       <font style=" margin-left: 26px;">&nbsp;&nbsp;Sufficient
                         <input type="text" class="border" name="boarding" readonly><?php if((isset($data['writing_value'])) && ($data['writing_value'] == 'Sufficient')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;</font> 
                         <font style=" margin-left: 18px;">
                          &nbsp;&nbsp;Intermediate
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['writing_value'])) && ($data['writing_value'] == 'Intermediate')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;</font> 
                           <font style=" margin-left: 20px;">
                            &nbsp;&nbsp;Beginner
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['writing_value'])) && ($data['writing_value'] == 'Beginner')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        </font>
                         <font style=" margin-left: 20px;">
                          &nbsp;&nbsp; None
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['writing_value'])) && ($data['writing_value'] == 'None')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;</font>
          						</p>
          						</div>
          						<br>
          							<label><b>SUPPORT SERVICES</b></label>
          						<p>
          							Are there any behavioral or learning support needs that we should be aware of? &nbsp;&nbsp;yes&nbsp;&nbsp;<input type="text" class="border" name="boarding" readonly><?php if((isset($data['support'])) && ($data['support'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;<input type="text" class="border" name="boarding" readonly><?php if((isset($data['support'])) && ($data['support'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
          						</p>
          						<p>
                        ...
                        <label><b>TRANSPORTATION PLAN - AIRPORT </b></label>

          						<p>
          							Will the applicant and their family require transport to and from Senai or Changi Airport, before and after the camp?<br>
                        Senai
                        <input type="text" class="border" name="boarding" readonly>
          							<?php if((isset($data['transportation'])) && ($data['transportation'] == 'Senai')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -20px;'>"; }?> <font style=" margin-left: 100px;">&nbsp;&nbsp;
                          Changi
                        <input type="text" class="border" name="boarding" readonly>
                        <?php if((isset($data['transportation'])) && ($data['transportation'] == 'Changi')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -20px;'>"; }?></font> <font style=" margin-left: 100px;">&nbsp;&nbsp;
                          No transport needed
                          <input type="text" class="border" name="boarding" readonly>
                          <?php if((isset($data['transportation'])) && ($data['transportation'] == 'No transport needed')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -20px;'>"; }?></font>
          						</p>
          						<p>
                       ...
                       &nbsp;&nbsp;yes&nbsp;&nbsp;<input type="text" class="border" name="boarding" readonly><?php if((isset($data['transport_student'])) && ($data['transport_student'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;<input type="text" class="border" name="boarding" readonly><?php if((isset($data['transport_student'])) && ($data['transport_student'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;	
          						</p>
          						<p>
          						...
          						<p>
          						  Danga Bay (Starbucks)
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['student_pickup'])) && ($data['student_pickup'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?></font><font style=" margin-left: 40px;">&nbsp;&nbsp;
                        Teega A (lobby)
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['student_pickup'])) && ($data['student_pickup'] == '2')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?></font><font style=" margin-left: 40px;"> &nbsp;&nbsp;
                        Teega B (lobby)
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['student_pickup'])) && ($data['student_pickup'] == '3')){ echo "<img src='../assets/images/check.png'  class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?></font>
                      </p>
                      <p>
                        
                        Teega Suites (lobby)
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['student_pickup'])) && ($data['student_pickup'] == '4')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        <font style=" margin-left: 50px;">&nbsp;&nbsp;
                        Mall of medini(lobby)
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['student_pickup'])) && ($data['student_pickup'] == '5')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?></font>
          						</p> 		
                      ...
                      <br>
                        ...
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['illnesses'])) && ($data['illnesses'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['illnesses'])) && ($data['illnesses'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						<p>
                          ...
                          &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['allergies'])) && ($data['allergies'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['allergies'])) && ($data['allergies'] == 'No')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						<p>
                        ...
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['mental_impairments'])) && ($data['mental_impairments'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['mental_impairments'])) && ($data['mental_impairments'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						<p>
                         ...
                         &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['slept_away'])) && ($data['slept_away'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['slept_away'])) && ($data['slept_away'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
                        ...
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['asthma'])) && ($data['asthma'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['asthma'])) && ($data['asthma'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>

          						<p>
          							Does he / she carry an asthma inhaler? 
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['inhaler'])) && ($data['inhaler'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['inhaler'])) && ($data['inhaler'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
                      <p>
                        Does your child wear glasses or contact lenses?
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['lenses'])) && ($data['lenses'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['lenses'])) && ($data['lenses'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?> 
                      </p>
          						<p>
          							Does your child have trouble hearing or use a hearing aid?
                        &nbsp;&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['hearing'])) && ($data['hearing'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['hearing'])) && ($data['hearing'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?> 
          						</p>

          						<p>
          							Is your child on daily medication?
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['daily_medication'])) && ($data['daily_medication'] == '1')){ echo "<img src='../assets/images/check.png'  class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['daily_medication'])) && ($data['daily_medication'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						...
          						<p>
          							Can your child swim? 
                        &nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['child_swim'])) && ($data['child_swim'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
                        &nbsp;&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['child_swim'])) && ($data['child_swim'] == '0')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						
          						<!--<p align="justify">
          							1. <input type="text" class="border" name="boarding" readonly><?php if((isset($data['attest_info'])) && ($data['attest_info'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='15px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp; I attest that all the above information is accurate.
          						</p>-->
          						
          						<p align="justify">
          							1. <input type="text" class="border" name="boarding" readonly><?php if((isset($data['give_permission'])) && ($data['give_permission'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='15px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp; I hereby give permission to the school to administer the following medications to my child if deemed necessary by the school nurse:		
          						</p>
                      ...
                      <label><b>PARENTAL DISCLOSURE AND ACKNOWLEDGMENT</b></label>

                      <p align="justify">
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['parental_disclosure1'])) && ($data['parental_disclosure1'] == '1')){ echo "<img src='../assets/images/check.png' class='signed_images' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                      ...
                      <p>
                        Parent Signature: ______________________________________ Date:&nbsp;&nbsp;<u><?php if($data['ack_date1'] != null){ echo date('d-m-Y',strtotime($data['ack_date1'])) ;}?></u>&nbsp;&nbsp; 
                      </p>
                      <p>
                        Parent Signature: ______________________________________ Date:&nbsp;&nbsp;<u><?php if($data['ack_date2'] != null){ echo date('d-m-Y',strtotime($data['ack_date2'])) ;}?></u>&nbsp;&nbsp;
                      </p>
                      <p>
          				...
          				<div class="formdiv col-md-12">
          					<div class="col-md-12 student_health">                  
          						...
          						<p>
          							...
          							: &nbsp;&nbsp;<u><?php if($data['date_head'] != null){ echo date('d-m-Y',strtotime($data['date_head'])) ;}?></u>&nbsp;&nbsp;
          							</font>
          						</p>
          						<br>
          						...
          						<!--<p>
          							Camp Name <font style="margin: 140px;">:&nbsp;&nbsp;<u><?php echo $data['camp_name'];?> - <?=date('d-m-Y',strtotime($data['start_date']));?> - <?=date('d-m-Y',strtotime($data['finish_date']));?> </u>&nbsp;&nbsp; </font>
          						</p>
          						<br>-->
                        ...
                        <?php 
                            $camp_name_str = "";
                            $ids = "'".str_replace(",", "','",$data['info_other_date2'])."'";
                            $sql1 = "SELECT * FROM camp_management WHERE camp_management_id IN ($ids)";
                            $query1 = mysqli_query($db,$sql1) or die(mysqli_error($db));
                            while($row1 = mysqli_fetch_assoc($query1)){
                              $camp_name_str .= $row1['camp_name'].'&nbsp;&nbsp;- &nbsp; '.date('d-m-Y',strtotime($row1['start_date'])).'&nbsp;&nbsp;- &nbsp; '.date('d-m-Y',strtotime($row1['finish_date'])).',';
                            }
                            $camp_name_str = rtrim($camp_name_str,',');
                            echo $camp_name_str;
                        ?>
                          </u>&nbsp;&nbsp;
          						</p>
                        ...
                        p.ex1 {
          				...
          				<div class="row">	
				          	<div class="col-md-12">
					          	...
					          	________________________________&nbsp;&nbsp;&nbsp;<u><?php if($data['other_sign_student_date1'] != null){ echo date('d-m-Y',strtotime($data['other_sign_student_date1'])) ;}?></u>&nbsp;&nbsp;
					          	<br>
          						Signature Of Student/ Participant &nbsp;&nbsp;&nbsp;&nbsp;Date
          						</div>
          						
				          		<div class="col-md-6">
				          		________________________________&nbsp;&nbsp;&nbsp;<u><?php if($data['other_sign_student_date2'] != null){ echo date('d-m-Y',strtotime($data['other_sign_student_date2'])) ;}?></u>&nbsp;&nbsp;
				          		<br>
                      ...
                      Student/ Participant Name 
          				...
          				<div class="row">	
				          	<div class="col-md-12">
          						...
          						<p>
          							Date: &nbsp;&nbsp;<u><?php if($data['office_date'] != null){ echo date('d-m-Y',strtotime($data['office_date'])) ;}?></u>&nbsp;&nbsp;
          						</p>
...
<?php
  ...
  $html2pdf = new \Mpdf\Mpdf(['tempDir' => __DIR__ . '/tmp']);
  $html2pdf->setAutoTopMargin = 'stretch';
  $material_file = strtoupper(uniqid()).'.pdf';
  $html2pdf->writeHTML($content);
  $html2pdf->Output($material_file, 'D');
