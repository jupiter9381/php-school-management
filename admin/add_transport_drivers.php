<?php include("header.php");
   if(isset($_GET['id']) && !empty($_GET['id'])){
        $id = $_GET['id'];
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM `transport_drivers` WHERE `transport_drivers_id` = '$id'"));
...
<section id="middle">
    ...
    <header id="page-header">
        <h1>Add Transport Drivers</h1>
    </header>
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
            <h2 class="panel-title"><?php echo isset($data['transport_drivers_id'])?'Edit TransportDriver':'Add Transport Drivers';?></h2>
            </div>
            <div class="panel-body">
                <form action="" id = "formaddtransportdrivers" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <input type="text"  placeholder = "Driving Licence Number" class = "form-control" name = "driving_licence" id = "driving_licence" title = "driving_licence Required"  value="<?php echo isset($data['driving_licence'])?$data['driving_licence']:''?>"required>
                                </div>                                 
                                <div class="col-md-6 col-sm-6">
                                    <label>Image *</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 text-center">
                                       <input type ="hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddTransportDrivers">
                                        <input type="submit"  id="formvalidate" data-form="formaddtransportdrivers"  class="btn btn-info btn-md btn-submit"  value="Add Transport Drivers">
                                    </div>
                                </div>
                            </div>
