<?php include("header.php");
   if(isset($_GET['id']) && !empty($_GET['id'])){
        $id = $_GET['id'];
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM `student_profile` WHERE `student_profile_id` = '$id'"));
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
							    ...
							    <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="fancy-form fancy-form-select">
                                        <select class="form-control select2" multiple id="camp_management_id" name="camp_management_id[]" required>
							...
							<div class="row"> 
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="col-md-6"><img style="max-width: 100%;" src="<?php echo '../uploads/'.$data['student_picture']?>"><div class="clearfix"></div></div>
                                <?php }?>
                                </div> 
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 text-center">
                                   <input type ="hidden" name = "studentid" id="studentid" value="<?php echo isset($id)?$id:'';?>">
                                    <input type ="hidden" name = "type" value="AddStudentProfile">
                                    <input type="submit"  id="formvalidate" data-form="formaddstudentprofile"  class="btn btn-info btn-md btn-submit"  value="<?php echo isset($id)?'Edit Student':'Add Student';?>">
                                </div>
