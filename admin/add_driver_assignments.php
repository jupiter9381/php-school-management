<?php include("header.php");
   if(isset($_GET['id']) && !empty($_GET['id'])){
        $id = $_GET['id'];
        $data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM `driver_assignments` WHERE `driver_assignments_id` = '$id'"));
...
<section id="middle">
    ...
    <header id="page-header">
        <h1>Add Driver Assignments</h1>
    </header>
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['driver_assignments_id'])?'Edit driverasignments':'Add Driver Assignments';?></h2>
            </div>
            <div class="panel-body">
                <form action="" id = "formadddriverassignments" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <input type="text"  placeholder = "Driving License Number" class = "form-control" name = "driving_license" id = "driving_license" title = "Address Required"  value="<?php echo isset($data['driving_license'])?$data['driving_license']:''?>"required>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <label>Image *</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 text-center">
                                       <input type ="hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddDriverAssignments">
                                        <input type="submit"  id="formvalidate" data-form="formadddriverassignments"  class="btn btn-info btn-md btn-submit"  value="Add Driver Assignments">
                                    </div>
                                </div>
                            </div>
