                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover sample_5" id="sample_5">
                            ...
                            <tbody>
                               ...
                               $q1 = mysqli_query($db, "SELECT a.*,s.student_name,t.first_name FROM incident_report a LEFT JOIN student_profile s ON a.student_profile_id=s.student_profile_id LEFT JOIN school_staff t ON a.school_staff_id=t.school_staff_id");
