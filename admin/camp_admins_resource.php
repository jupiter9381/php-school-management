    ...
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['camp_teacher_id'])?'Edit CampAdmins':'Camp Admins';?></h2>
            </div>
            <div class="panel-body">
                <form action="" id = "formaddcampadmins" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">

                            <div class="row">                                
                                <div class="col-md-6 col-sm-6 ">
                                    <label>Camp Admins *</label>
                                ...
                                <div class="col-md-6 col-sm-6" style=" top: 25px";>
                                    ...
                                    <input type = "hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddCampAdmins">
                                        <input type="submit"  id="formvalidate" data-form="formaddaampadmins"  class="btn btn-info btn-md btn-submit"  value="Search Camp Admins">
                                </div> 
                            </div>
