                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr id="name">
                                        ...
                                        <!--<td><a href="../upload/<?php echo $r1['final_application_form'];?>"><i class="fa fa-download"> Download</i> </a></td>-->
                                        <td>
                                            ...
                                            <?php } ?>
                                            <a class="btn btn-xs btn-primary " href="camper_application_form.php?id=<?php echo $r1['student_app_id'];?>" title="Print Application Student" data-id="<?php echo $r1['student_app_id']; ?>"><i class="fa fa-print"> Print</i></a> 
