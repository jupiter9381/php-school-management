                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <label class="radio-inline">
                                      <input type="radio" name="gender" id="gender" value="Male" <?php if((isset($data['gender'])) && ($data['gender']=='Male')){ echo "checked"; } ?> required >Male
                                    </label>
                                    <label class="radio-inline">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <input type="text"  placeholder = "Current grade" class = "form-control" name = "grade" id = "current_grade" title = "Current Grade Required"  value="<?php echo isset($data['grade'])?$data['grade']:''?>" required >
                                </div>
                            ...
                            <div class="collapse" id="family_info">   
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Parent 1 Mobile Number" class = "form-control" name = "mother_mobile" id = "mother_mobile" title = "Mother Mobile Required"  value="<?php echo isset($data['mother_mobile'])?$data['mother_mobile']:''?>" >
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Parent 2" class = "form-control" name = "father_name" id = "father_name" title = "Father Name Required"  value="<?php echo isset($data['father_name'])?$data['father_name']:''?>">
                                    </div>
                                    <div class="col-md-6 col-sm-6 ">
                                ...
                                <div class="row">
                                     <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <input type="text"  placeholder = "Parent 2 Mobile Number" class = "form-control" name = "father_mobile" id = "father_mobile" title = "Parent 2 Mobile Required"  value="<?php echo isset($data['father_mobile'])?$data['father_mobile']:''?>">
                                    </div>
                                </div> 
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 ">
                                        <label class="switch switch switch-round">Boarding Allocation Requested? &nbsp;
                                            <input type="checkbox" class="not_extra" name="boarding_allocation_req" id="boarding_allocation_req" value="1" <?php if((isset($data['boarding_allocation_req'])) && ($data['boarding_allocation_req']=='1')){ echo "checked"; } ?> >
                                            <span class="switch-label" data-on="YES" data-off="NO"></span>
                                        </label>
                                    </div> 
                                </div>
...
<div class="panel panel-default">
                            ...
                            <div class="collapse" id="parental_disclosure_head">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Date</label>
                                        <input type="text" class="form-control datepicker" data-format="dd-mm-yyyy" data-lang="en" data-RTL="false"  placeholder = "Select Date" class = "form-control" name = "ack_date1" id = "ack_date1" title = "Date Required"  value="<?php echo isset($data['ack_date1'])?date('d-m-Y',strtotime($data['ack_date1'])):'';?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <label>Date</label>
                                        <input type="text" class="form-control datepicker" data-format="dd-mm-yyyy" data-lang="en" data-RTL="false"  placeholder = "Select Date" class = "form-control" name = "ack_date2" id = "ack_date2" title = "Date Required"  value="<?php echo isset($data['ack_date2'])?date('d-m-Y',strtotime($data['ack_date2'])):'';?>">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            ...
                            <div class="collapse" id="others_head">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                         <input type="text" class="form-control datepicker" data-format="dd-mm-yyyy" data-lang="en" data-RTL="false"  placeholder = "Select Date" name = "date_head" id = "date_head" title = "Date Head Required"  value="<?php echo isset($data['date_head'])?date('d-m-Y',strtotime($data['date_head'])):'';?>">
                                    </div>
                                </div>
                                <!--<div class="row">
                                     <div class="col-md-2 col-sm-2">
                                        ...
                                        <ol>
                                            ...
                                            <input type="text" placeholder="Passport Number" class="form-control" name="info_other_date1" id="info_other_date1" value="<?php echo isset($data['info_other_date1'])?$data['info_other_date1']:''?>">
                                             ...
                                             To participate in the RafflesAmerican School Camp on 
                                                ...
                                                <div class="fancy-form fancy-form-select">
                                        <select class="form-control select2" multiple id="info_other_date2" name="info_other_date2[]">
                                            <option value="">--Select--</option>
                                            <?php
                                                $student_list = array();
                                                if(isset($data['info_other_date2'])){
                                                    if(strpos($data['info_other_date2'], ',')){
                                                        $student_list = explode(',', $data['info_other_date2']);
                                                    }else{
                                                        $student_list[] = $data['info_other_date2'];
                                                    }
                                                }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        <label>Date:</label>
                                        <input type="text" class="form-control datepicker" data-format="dd-mm-yyyy" data-lang="en" data-RTL="false"  placeholder = "Select Date" name = "other_sign_student_date1" id = "other_sign_student_date1" title = "Date Student/Participant Required"  value="<?php echo isset($data['other_sign_student_date1'])?date('d-m-Y',strtotime($data['other_sign_student_date1'])):'';?>">
                                    </div>
                                    <div class="col-md-3 col-sm-3">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        <label>Date:</label>
                                        <input type="text" class="form-control datepicker" data-format="dd-mm-yyyy" data-lang="en" data-RTL="false"  placeholder = "Select Date" name = "other_sign_student_date2" id = "other_sign_student_date2" title = "Date  Required"  value="<?php echo isset($data['other_sign_student_date2'])?date('d-m-Y',strtotime($data['other_sign_student_date2'])):'';?>">
                                    </div>
                                </div> 
                            ...
                            <div class="row">
                                ...
                                <div class="fancy-file-upload fancy-file-primary">
                                    <i class="fa fa-upload"></i>
                                    <input type="file" class="form-control" name="final_application_form" onchange="jQuery(this).next('input').val(this.value);" accept="'jpg','jpeg','png','JPG','JPEG','PNG','pdf','doc','docx','txt','xls','xlsx','csv'">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 text-center">
                                       <input type ="hidden" name = "applicationid" id="applicationid" value="<?php echo isset($id)?$id:'';?>">
                                        ...
                                        <input type="submit"  id="formvalidate" data-form="formaddproject"  class="btn btn-info btn-md btn-submit"  value="Submit and Print Application">
                                    </div>
                                </div>
                            </div>
                        </div>
