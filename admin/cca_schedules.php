...
<section id="middle">
    ...
    <header id="page-header">
        <h1>CCA (Sporting) Schedules</h1>
    </header>
    <div id="content" class="dashboard padding-20">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><?php echo isset($data['camp_teacher_id'])?'Edit CCASchedules':'CCA (Sporting) Schedules';?></h2>
            </div>
            <div class="panel-body">
                <form action="" id = "formaddccaschedules" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <div class="form-group">

                            <div class="row">                                
                                <div class="col-md-6 col-sm-6 ">
                                    <label>CCA (Sporting) Schedules *</label>
                                ...
                                <div class="col-md-6 col-sm-6" style=" top: 25px";>
                                    ...
                                    <input type = "hidden" name = "txtid" id="txtid" value="<?php echo isset($id)?$id:'';?>">
                                        <input type ="hidden" name = "type" value="AddCCASchedules">
                                        <input type="submit"  id="formvalidate" data-form="formaddccaschedules"  class="btn btn-info btn-md btn-submit"  value="Search  ccaschedules">
                                </div> 
                            </div>
