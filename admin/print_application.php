          ...
          <section>
          		<div class="cotainer">
                      ...
                      <p>
                       ...
                       Boarding Allocation Requested?&nbsp;&nbsp; Yes &nbsp;&nbsp; <input type="text" class="border" name="boarding" readonly><?php if((isset($data['boarding_allocation_req'])) && ($data['boarding_allocation_req'] == '1')){ echo "<img src='../assets/images/check.png' width='13px' height='13px'  style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;&nbsp;&nbsp; No &nbsp;&nbsp;  <input type="text" class="border" name="boarding" readonly><?php if((isset($data['boarding_allocation_req'])) && ($data['boarding_allocation_req'] == '0')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>  
                      </p>
          						<p>
          						...
          						<p>
          							<input type="text" class="border" name="boarding" readonly><?php if((isset($data['is_reading'])) && ($data['is_reading'] == '1')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                        Reading
                        ...
                        <font style=" margin-left: 21px;">
                          ...
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['reading_value'])) && ($data['reading_value'] == 'None')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
          						...
          						<p>
          						   <input type="text" class="border" name="boarding" readonly><?php if((isset($data['is_speaking'])) && ($data['is_speaking'] == '1')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                          Speaking
                         <font style=" margin-left: 21px;">
                          Sufficient
                         ...
                         <font style=" margin-left: 18px;">
                          ...
                          <input type="text" class="border" name="boarding" readonly><?php if((isset($data['speaking_value'])) && ($data['speaking_value'] == 'None')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						...
          						<p>
          						   <input type="text" class="border" name="boarding" readonly><?php if((isset($data['is_writing'])) && ($data['is_writing'] == '1')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>&nbsp;&nbsp;
                          Writing
                      ...
                      <br>
                        ...
                        &nbsp;&nbsp;No&nbsp;&nbsp;
                        <input type="text" class="border" name="boarding" readonly><?php if((isset($data['allergies'])) && ($data['allergies'] == 'No')){ echo "<img src='../assets/images/check.png' width='13px' height='13px' style = 'margin-left: -16px;'>"; }?>
          						</p>
          						<p>
